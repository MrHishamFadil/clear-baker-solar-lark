...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DZRb9xpX.mjs");
...
var manifest = { "daef94b3928363e7cc8c18cfd62b2ecf03ea36ddb53468b4a634d0117c53daa3": {
	functionName: "synthesizeSpeech_createServerFn_handler",
	importer: () => import("./tts-BXIzZrqA.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BG14YB50.mjs").then((n) => n.t),
